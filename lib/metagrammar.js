PEG.grammarParser = (function(){
  ...
  var result = {
    ...
    _parse_classCharacterRange: function(context) {
      ...
      if (result207 !== null) {
        ...
        if (result208 !== null) {
          ...
          if (result209 !== null) {
            var result206 = [result207, result208, result209];
          } else {
            var result206 = null;
    ...
    _parse_classCharacter: function(context) {
      ...
      var result211 = this._parse_bracketDelimitedCharacter(context);
      var result210 = result211 !== null
        ? (function() { 
          return PEG.RegExpUtils.quoteForClass((arguments[0]));
         }).call(this, result211)
        : null;
    ...
    _parse_bracketDelimitedCharacter: function(context) {
      ...
      var result218 = this._parse_simpleBracketDelimitedCharacter(context);
      if (result218 !== null) {
        var result212 = result218;
      } else {
        var result217 = this._parse_simpleEscapeSequence(context);
        if (result217 !== null) {
          var result212 = result217;
        } else {
          var result216 = this._parse_zeroEscapeSequence(context);
          if (result216 !== null) {
            var result212 = result216;
          } else {
            var result215 = this._parse_hexEscapeSequence(context);
            if (result215 !== null) {
              var result212 = result215;
            } else {
              var result214 = this._parse_unicodeEscapeSequence(context);
              if (result214 !== null) {
                var result212 = result214;
              } else {
                var result213 = this._parse_eolEscapeSequence(context);
                if (result213 !== null) {
                  var result212 = result213;
                } else {
                  var result212 = null;;
                };
              };
    ...
    _parse_simpleBracketDelimitedCharacter: function(context) {
      ...
      if (result226 !== null) {
        ...
        if (result225 !== null) {
          var result223 = result225;
        } else {
          var result224 = this._parse_eolChar(context);
          if (result224 !== null) {
            var result223 = result224;
          } else {
            var result223 = null;;
          };
        };
      ...
      if (result221 !== null) {
        if (this._input.length > this._pos) {
          var result222 = this._input.charAt(this._pos);
          this._pos++;
        } else {
          var result222 = null;
          if (context.reportMatchFailures) {
        ...
        if (result222 !== null) {
          var result220 = [result221, result222];
        } else {
          var result220 = null;
      ...
      var result219 = result220 !== null
        ? (function() {  return (arguments[1]);  }).apply(this, result220)
        : null;
    ...
    _parse_simpleEscapeSequence: function(context) {
      ...
      if (result229 !== null) {
        ...
        context.reportMatchFailures = false;
        var result236 = this._parse_digit(context);
        if (result236 !== null) {
          ...
          if (result235 !== null) {
            ...
            if (result234 !== null) {
              ...
              var result233 = this._parse_eolChar(context);
              if (result233 !== null) {
        ...
        if (result230 !== null) {
          if (this._input.length > this._pos) {
            var result231 = this._input.charAt(this._pos);
            this._pos++;
          } else {
            var result231 = null;
            if (context.reportMatchFailures) {
          ...
          if (result231 !== null) {
            var result228 = [result229, result230, result231];
          } else {
            var result228 = null;
    ...
    _parse_zeroEscapeSequence: function(context) {
      ...
      if (result239 !== null) {
        ...
        context.reportMatchFailures = false;
        var result241 = this._parse_digit(context);
        ...
        if (result240 !== null) {
          var result238 = [result239, result240];
        } else {
          var result238 = null;
      ...
      var result237 = result238 !== null
        ? (function() {  return "\0";  }).apply(this, result238)
        : null;
    ...
    _parse_hexEscapeSequence: function(context) {
      ...
      if (result244 !== null) {
        ...
        if (result245 !== null) {
          ...
          if (result246 !== null) {
            var result243 = [result244, result245, result246];
          } else {
            var result243 = null;
        ...
        if (result250 !== null) {
          ...
          if (result251 !== null) {
            ...
            if (result252 !== null) {
              ...
              if (result253 !== null) {
                var result248 = [result249, result250, result251, result252, result253];
              } else {
                var result248 = null;
    ...
    _parse_eolEscapeSequence: function(context) {
      ...
      if (result256 !== null) {
        var result257 = this._parse_eol(context);
        if (result257 !== null) {
          var result255 = [result256, result257];
        } else {
          var result255 = null;
      ...
      var result254 = result255 !== null
        ? (function() {  return (arguments[1]);  }).apply(this, result255)
        : null;
    ...
    _parse_letter: function(context) {
      ...
      var result262 = this._parse_lowerCaseLetter(context);
      if (result262 !== null) {
        var result260 = result262;
      } else {
        var result261 = this._parse_upperCaseLetter(context);
        if (result261 !== null) {
          var result260 = result261;
        } else {
          var result260 = null;;
        };
      }
    ...
    _parse___: function(context) {
      ...
      var result265 = [];
      var result269 = this._parse_whitespace(context);
      if (result269 !== null) {
        var result266 = result269;
      } else {
        var result268 = this._parse_eol(context);
        if (result268 !== null) {
          var result266 = result268;
        } else {
          var result267 = this._parse_comment(context);
          if (result267 !== null) {
    ...
    _parse_comment: function(context) {
      ...
      var savedReportMatchFailures = context.reportMatchFailures;
      context.reportMatchFailures = false;
      var result272 = this._parse_singleLineComment(context);
      if (result272 !== null) {
        var result270 = result272;
      } else {
        var result271 = this._parse_multiLineComment(context);
        if (result271 !== null) {
          var result270 = result271;
        } else {
          var result270 = null;;
        };
      }
      context.reportMatchFailures = savedReportMatchFailures;
      if (context.reportMatchFailures && result270 === null) {
    ...
    _parse_singleLineComment: function(context) {
      ...
      if (result274 !== null) {
        ...
        context.reportMatchFailures = false;
        var result279 = this._parse_eolChar(context);
        ...
        if (result277 !== null) {
          if (this._input.length > this._pos) {
            var result278 = this._input.charAt(this._pos);
            this._pos++;
          } else {
            var result278 = null;
            if (context.reportMatchFailures) {
          ...
          if (result278 !== null) {
            var result276 = [result277, result278];
          } else {
            var result276 = null;
        ...
        while (result276 !== null) {
          result275.push(result276);
          var savedPos46 = this._pos;
          var savedPos47 = this._pos;
          var savedReportMatchFailuresVar6 = context.reportMatchFailures;
          context.reportMatchFailures = false;
    ...
    _parse_multiLineComment: function(context) {
      ...
      if (result281 !== null) {
        ...
        if (result285 !== null) {
          if (this._input.length > this._pos) {
            var result286 = this._input.charAt(this._pos);
            this._pos++;
          } else {
            var result286 = null;
            if (context.reportMatchFailures) {
        ...
        if (result282 !== null) {
          ...
          if (result283 !== null) {
            var result280 = [result281, result282, result283];
          } else {
            var result280 = null;
    ...
    _parse_eol: function(context) {
      ...
      context.reportMatchFailures = savedReportMatchFailures;
      if (context.reportMatchFailures && result288 === null) {
    ...
    _parse_whitespace: function(context) {
      ...
      context.reportMatchFailures = false;
      if (this._input.substr(this._pos).match(/^[ 	 ﻿ ᠎ -   　]/) !== null) {
        var result295 = this._input.charAt(this._pos);
        this._pos++;
      } else {
        var result295 = null;
        if (context.reportMatchFailures) {
