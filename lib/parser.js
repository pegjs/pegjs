module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c129 = { type: "other", description: "regular expression" },
        peg$c130 = function(pattern, flags) {
              var value;
        ...
        peg$c139 = /^[0-9a-f]/i,
        peg$c140 = { type: "class", value: "[0-9a-f]i", description: "[0-9a-f]i" },
        peg$c141 = ".",
        peg$c142 = { type: "literal", value: ".", description: "\".\"" },
        peg$c143 = function() { return { type: "any", location: location() }; },
    ...
    function peg$parseCodeNotRegExp() {
      var s0, s1, s2;

      s0 = peg$parseComment();
      if (s0 === peg$FAILED) {
        s0 = peg$parseTokenThenRegularExpressionLiteral();
        if (s0 === peg$FAILED) {
          ...
          if (s0 === peg$FAILED) {
            ...
            s1 = peg$parseCodeBlock();
            if (s1 !== peg$FAILED) {
              s2 = peg$parseWhitespaceRegularExpressionLiteral();
              if (s2 === peg$FAILED) {
                s2 = null;
              }
              if (s2 !== peg$FAILED) {
    ...
    function peg$parseTokenThenRegularExpressionLiteral() {
      var s0, s1, s2;
    ...
    function peg$parseWhitespaceRegularExpressionLiteral() {
      var s0, s1, s2;
