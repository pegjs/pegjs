module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$f1 = function(code) { return { type: "initializer", code: code }; },
        peg$f2 = function(name, displayName, expression) {
              return {
                type:        "rule",
                name:        name,
        ...
        peg$f3 = function(first, rest) {
              return rest.length > 0
                ? { type: "choice", alternatives: buildList(first, rest, 3) }
                : first;
            },
        peg$f4 = function(expression, code) {
              return code !== null
                ? { type: "action", expression: expression, code: code[1] }
                : expression;
            },
        peg$f5 = function(first, rest) {
              return rest.length > 0
                ? { type: "sequence", elements: buildList(first, rest, 1) }
                : first;
            },
        peg$f6 = function(label, expression) {
              return { type: "labeled", label: label, expression: expression };
            },
        peg$f7 = function(operator, expression) {
              return { type: OPS_TO_PREFIXED_TYPES[operator], expression: expression };
            },
        peg$f8 = function(expression, operator) {
              return { type: OPS_TO_SUFFIXED_TYPES[operator], expression: expression };
            },
        peg$f9 = function(expression) { return expression; },
        peg$f10 = function(name) {
              return { type: "rule_ref", name: name };
            },
        peg$f11 = function(operator, code) {
              return { type: OPS_TO_SEMANTIC_PREDICATE_TYPES[operator], code: code };
            },
        peg$f12 = function(name) { return name; },
        peg$f13 = function(first, rest) { return first + rest.join(""); },
        peg$f14 = function(sequence) { return sequence; },
        peg$f15 = function(value, ignoreCase) {
              return { type: "literal", value: value, ignoreCase: ignoreCase !== null };
            },
        peg$f16 = function(chars) { return chars.join(""); },
        peg$f17 = function() { return text(); },
        peg$f18 = function(inverted, parts, ignoreCase) {
              return {
                type:       "class",
        ...
        peg$f20 = function() { return ""; },
        peg$f21 = function() { return "\0"; },
        peg$f22 = function() { return "\b";   },
        peg$f23 = function() { return "\f";   },
        peg$f24 = function() { return "\n";   },
        peg$f25 = function() { return "\r";   },
        peg$f26 = function() { return "\t";   },
        peg$f27 = function() { return "\x0B"; },
        peg$f28 = function(digits) {
              return String.fromCharCode(parseInt(digits, 16));
            },
        peg$f29 = function() { return { type: "any" }; },
        peg$f30 = function(code) { return code; },
