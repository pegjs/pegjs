...
var compiler = {
  ...
  passes: {
    ...
    generate_stackvm: {
      astToStackVM:        require("./compiler/passes/ast-to-stackvm"),
      stackVMToJavascript: require("./compiler/passes/stackvm-to-javascript")
    },
    generate: {
      astToRegAllocJS:   require("./compiler/passes/ast-to-regalloc-js")
    }
  },
