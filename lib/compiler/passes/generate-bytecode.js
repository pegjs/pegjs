      ...
      function buildElementsCode(elements, context) {
        ...
        if (elements.length > 0) {
          ...
          return buildSequence(
            generate(elements[0], {
              sp:     context.sp,
              // If in one sequence there is the second sequence, clone an environment therefore
              // actions and predicates won't see labels from parallel groups.
              // This solves issue https://github.com/pegjs/pegjs/issues/396.
              env:    elements[0].type !== 'sequence' ? context.env : objects.clone(context.env),
              action: null
            }),
            buildCondition(
              [op.IF_NOT_ERROR],
