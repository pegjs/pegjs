...
function peg$parse(input, options) {
  ...
  var peg$f13 = function(operator, code) {
  ...
  var peg$f32 = function() { return createNode( "any", {} ); };
  var peg$f33 = function(code) { return code; };
  var peg$f34 = function() { error("Unbalanced brace."); };
